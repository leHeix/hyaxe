...
* 'configure.py --cpu=x86_32 --os=linux --cc=clang --disable-shared-library --amalgamation --minimized-build --enable-modules=bcrypt,system_rng --with-debug-info'
*
* Target
*  - Compiler: clang++ -fstack-protector -m32 -pthread -std=c++20 -D_REENTRANT -g -O3
*  - Arch: x86_32
*  - OS: linux
*/
