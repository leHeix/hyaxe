...
* 'configure.py --cpu=x86_32 --os=windows --msvc-runtime=MT --disable-shared-library --amalgamation --minimized-build --enable-modules=bcrypt,system_rng'
*
* Target
*  - Compiler: cl  /std:c++20 /EHs /GR /MT /bigobj /O2 /Oi /Zc:throwingNew
*  - Arch: x86_32
*  - OS: windows
*/
